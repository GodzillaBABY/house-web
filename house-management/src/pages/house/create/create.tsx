...
import './create.less';
import { postCreatRoom } from '@/utils/request/request';
...
const Create = () => {
  ...
  const [activeDistricts, setDistricts] = useState('')
  ...
  return (<div>
    ...
    /> : <Form  {...layout} name='create' ref={imgRef} className='creat-form' onFinish={onFinish} onValuesChange={(e) => { console.log(e) }} validateMessages={validateMessages}>
        <Form.Item name={['room', 'name']} label='房源名称' rules={[{ required: true }]} className='creat-form-item'>
          <Input />
        </Form.Item>
        <Form.Item name={['room', 'id']} className='creat-form-item' label='房源编号' rules={[{ required: true }]}>
  ...
  >
    <Input />
        ...
        <Form.Item name={['room', 'matchingTag']} label='配套设施' className='creat-form-item' rules={[{ required: true }]}>
          <Checkbox.Group>
            <Row>
              <Col span={8}>
        ...
        <Form.Item name={['room', 'nearby']} className='creat-form-item item-nearby' label='附近信息:' >
        ...
        <Form.Item name={['room', 'contactPhone']} className='creat-form-item item-contactPhone' label='管理人电话'
          rules={[{ required: true, message: '请输入联系人电话!' }]}
        >
          <Input type='tel' size='middle' className='input-contactPhone' />
        </Form.Item>
        <Form.Item name={['room', 'contactWechat']} className='creat-form-item item-contactWechat' label='管理人微信' >
